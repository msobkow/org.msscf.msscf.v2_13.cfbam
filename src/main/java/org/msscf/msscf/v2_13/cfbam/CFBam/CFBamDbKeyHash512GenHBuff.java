// Description: Java 11 implementation of a DbKeyHash512Gen history buffer object.
...
public class CFBamDbKeyHash512GenHBuff
	extends CFBamDbKeyHash512TypeHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash512GenHBuff() {
		super();
		optionalDispenserTenantId = null;
		optionalDispenserId = null;
		requiredSlice = CFBamDbKeyHash512GenBuff.SLICE_INIT_VALUE;
		requiredBlockSize = CFBamDbKeyHash512GenBuff.BLOCKSIZE_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash512GenBuff.CLASS_CODE );
	}
	...
	public void setOptionalDispenserTenantId( Long value ) {
		...
		else if( value < CFBamDbKeyHash512GenBuff.DISPENSERTENANTID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserTenantId",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.DISPENSERTENANTID_MIN_VALUE );
		}
		else {
	...
	public void setOptionalDispenserId( Long value ) {
		...
		else if( value < CFBamDbKeyHash512GenBuff.DISPENSERID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserId",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.DISPENSERID_MIN_VALUE );
		}
		else {
	...
	public void setRequiredSlice( short value ) {
		if( value < CFBamDbKeyHash512GenBuff.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.SLICE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash512GenBuff.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( value < CFBamDbKeyHash512GenBuff.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.BLOCKSIZE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash512GenBuff.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash512GenBuff.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash512GenHBuff ) {
			CFBamDbKeyHash512GenHBuff rhs = (CFBamDbKeyHash512GenHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash512GenBuff ) {
			CFBamDbKeyHash512GenBuff rhs = (CFBamDbKeyHash512GenBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash512GenByDispIdxKey ) {
			CFBamDbKeyHash512GenByDispIdxKey rhs = (CFBamDbKeyHash512GenByDispIdxKey)obj;
			if( getOptionalDispenserTenantId() != null ) {
				if( rhs.getOptionalDispenserTenantId() != null ) {
					if( ! getOptionalDispenserTenantId().equals( rhs.getOptionalDispenserTenantId() ) ) {
						return( false );
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash512GenBuff ) {
			setDbKeyHash512GenBuff( (CFBamDbKeyHash512GenBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamDbKeyHash512GenBuff" );
		}
	}

	public void setDbKeyHash512GenBuff( CFBamDbKeyHash512GenBuff src ) {
		super.setDbKeyHash512TypeBuff( src );
	...
	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash512GenHBuff ) {
			setDbKeyHash512GenBuff( (CFBamDbKeyHash512GenHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash512GenHBuff" );
		}
	}

	public void setDbKeyHash512GenBuff( CFBamDbKeyHash512GenHBuff src ) {
		super.setDbKeyHash512TypeBuff( src );
		setOptionalDispenserTenantId( src.getOptionalDispenserTenantId() );
		setOptionalDispenserId( src.getOptionalDispenserId() );
		setRequiredSlice( src.getRequiredSlice() );
