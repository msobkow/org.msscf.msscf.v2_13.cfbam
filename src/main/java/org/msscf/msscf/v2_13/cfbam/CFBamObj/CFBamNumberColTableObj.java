	...
	implements ICFBamNumberColTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamNumberColObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamNumberColObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamNumberColObj realiseNumberCol( ICFBamNumberColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamNumberColObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamNumberColObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public ICFBamNumberColObj createNumberCol( ICFBamNumberColObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableNumberCol().createNumberCol(
			...
			buff );
		obj.copyBuffToPKey();
		if( obj.getPKey().getClassCode().equals( "a87d" ) ) {
	...
	public List<ICFBamNumberColObj> readNumberColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readNumberColByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamNumberColObj> readNumberColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readNumberColByCodeVisIdx";
	...
	public List<ICFBamNumberColObj> readNumberColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readNumberColByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamNumberColObj> readNumberColByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readNumberColByScopeCodeVisIdx";
	...
	public List<ICFBamNumberColObj> readCachedNumberColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedNumberColByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamNumberColObj> arrayList = new ArrayList<ICFBamNumberColObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamNumberColObj> readCachedNumberColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedNumberColByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeNumberColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeNumberColByCodeVisIdx";
		ICFBamNumberColObj obj;
		List<ICFBamNumberColObj> arrayList = readCachedNumberColByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamNumberColObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeNumberColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeNumberColByScopeCodeVisIdx";
		ICFBamNumberColObj obj;
		List<ICFBamNumberColObj> arrayList = readCachedNumberColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamNumberColObj> arrayIter = arrayList.iterator();
	...
	public ICFBamNumberColObj updateNumberCol( ICFBamNumberColObj Obj ) {
		...
		if( Obj.getClassCode().equals( "a87d" ) ) {
			obj = (ICFBamNumberColObj)Obj.realise();
		}
		obj.endEdit();
		return( obj );
	...
	public void deleteNumberColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamNumberColObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableNumberCol().deleteNumberColByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamNumberColObj> iter = dict.values().iterator();
			ICFBamNumberColObj obj;
			List<ICFBamNumberColObj> toForget = new LinkedList<ICFBamNumberColObj>();
		...
		deepDisposeNumberColByCodeVisIdx( CodeVis );
	}

	public void deleteNumberColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamNumberColObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableNumberCol().deleteNumberColByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamNumberColObj> iter = dict.values().iterator();
		...
		deepDisposeNumberColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
