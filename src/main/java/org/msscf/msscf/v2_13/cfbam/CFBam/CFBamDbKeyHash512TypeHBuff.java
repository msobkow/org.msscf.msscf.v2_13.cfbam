// Description: Java 11 implementation of a DbKeyHash512Type history buffer object.
...
public class CFBamDbKeyHash512TypeHBuff
	extends CFBamDbKeyHash512DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash512TypeHBuff() {
		super();
		requiredSchemaDefId = CFBamDbKeyHash512TypeBuff.SCHEMADEFID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash512TypeBuff.CLASS_CODE );
	}
	...
	public void setRequiredSchemaDefId( long value ) {
		if( value < CFBamDbKeyHash512TypeBuff.SCHEMADEFID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSchemaDefId",
				1,
				"value",
				value,
				CFBamDbKeyHash512TypeBuff.SCHEMADEFID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash512TypeHBuff ) {
			CFBamDbKeyHash512TypeHBuff rhs = (CFBamDbKeyHash512TypeHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash512TypeBuff ) {
			CFBamDbKeyHash512TypeBuff rhs = (CFBamDbKeyHash512TypeBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash512TypeBySchemaIdxKey ) {
			CFBamDbKeyHash512TypeBySchemaIdxKey rhs = (CFBamDbKeyHash512TypeBySchemaIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredSchemaDefId() != rhs.getRequiredSchemaDefId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash512TypeBuff ) {
			setDbKeyHash512TypeBuff( (CFBamDbKeyHash512TypeBuff)src );
		}
		else {
	...
	public void setDbKeyHash512TypeBuff( CFBamDbKeyHash512TypeBuff src ) {
		super.setDbKeyHash512DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash512TypeHBuff ) {
			setDbKeyHash512TypeBuff( (CFBamDbKeyHash512TypeHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash512TypeHBuff" );
		}
	}

	public void setDbKeyHash512TypeBuff( CFBamDbKeyHash512TypeHBuff src ) {
		super.setDbKeyHash512DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}
}
