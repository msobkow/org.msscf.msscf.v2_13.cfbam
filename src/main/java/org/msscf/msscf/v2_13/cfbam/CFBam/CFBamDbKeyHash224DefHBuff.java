// Description: Java 11 implementation of a DbKeyHash224Def history buffer object.
...
public class CFBamDbKeyHash224DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash224DefHBuff() {
		super();
		optionalInitValue = null;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash224DefBuff.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash224DefHBuff ) {
			CFBamDbKeyHash224DefHBuff rhs = (CFBamDbKeyHash224DefHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash224DefBuff ) {
			CFBamDbKeyHash224DefBuff rhs = (CFBamDbKeyHash224DefBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash224DefBuff ) {
			setDbKeyHash224DefBuff( (CFBamDbKeyHash224DefBuff)src );
		}
		else {
	...
	public void setDbKeyHash224DefBuff( CFBamDbKeyHash224DefBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash224DefHBuff ) {
			setDbKeyHash224DefBuff( (CFBamDbKeyHash224DefHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash224DefHBuff" );
		}
	}

	public void setDbKeyHash224DefBuff( CFBamDbKeyHash224DefHBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}
}
