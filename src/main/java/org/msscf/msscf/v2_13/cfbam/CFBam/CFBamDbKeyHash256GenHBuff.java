// Description: Java 11 implementation of a DbKeyHash256Gen history buffer object.
...
public class CFBamDbKeyHash256GenHBuff
	extends CFBamDbKeyHash256TypeHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash256GenHBuff() {
		super();
		optionalDispenserTenantId = null;
		optionalDispenserId = null;
		requiredSlice = CFBamDbKeyHash256GenBuff.SLICE_INIT_VALUE;
		requiredBlockSize = CFBamDbKeyHash256GenBuff.BLOCKSIZE_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash256GenBuff.CLASS_CODE );
	}
	...
	public void setOptionalDispenserTenantId( Long value ) {
		...
		else if( value < CFBamDbKeyHash256GenBuff.DISPENSERTENANTID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserTenantId",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.DISPENSERTENANTID_MIN_VALUE );
		}
		else {
	...
	public void setOptionalDispenserId( Long value ) {
		...
		else if( value < CFBamDbKeyHash256GenBuff.DISPENSERID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserId",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.DISPENSERID_MIN_VALUE );
		}
		else {
	...
	public void setRequiredSlice( short value ) {
		if( value < CFBamDbKeyHash256GenBuff.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.SLICE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash256GenBuff.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( value < CFBamDbKeyHash256GenBuff.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.BLOCKSIZE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash256GenBuff.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash256GenBuff.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash256GenHBuff ) {
			CFBamDbKeyHash256GenHBuff rhs = (CFBamDbKeyHash256GenHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash256GenBuff ) {
			CFBamDbKeyHash256GenBuff rhs = (CFBamDbKeyHash256GenBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash256GenByDispIdxKey ) {
			CFBamDbKeyHash256GenByDispIdxKey rhs = (CFBamDbKeyHash256GenByDispIdxKey)obj;
			if( getOptionalDispenserTenantId() != null ) {
				if( rhs.getOptionalDispenserTenantId() != null ) {
					if( ! getOptionalDispenserTenantId().equals( rhs.getOptionalDispenserTenantId() ) ) {
						return( false );
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash256GenBuff ) {
			setDbKeyHash256GenBuff( (CFBamDbKeyHash256GenBuff)src );
		}
		else {
	...
	public void setDbKeyHash256GenBuff( CFBamDbKeyHash256GenBuff src ) {
		super.setDbKeyHash256TypeBuff( src );
	...
	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash256GenHBuff ) {
			setDbKeyHash256GenBuff( (CFBamDbKeyHash256GenHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash256GenHBuff" );
		}
	}

	public void setDbKeyHash256GenBuff( CFBamDbKeyHash256GenHBuff src ) {
		super.setDbKeyHash256TypeBuff( src );
		setOptionalDispenserTenantId( src.getOptionalDispenserTenantId() );
		setOptionalDispenserId( src.getOptionalDispenserId() );
		setRequiredSlice( src.getRequiredSlice() );
