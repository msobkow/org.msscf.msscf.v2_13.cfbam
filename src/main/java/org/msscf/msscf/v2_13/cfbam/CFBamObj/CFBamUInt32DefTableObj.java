	...
	implements ICFBamUInt32DefTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt32DefObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt32DefObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamUInt32DefObj realiseUInt32Def( ICFBamUInt32DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt32DefObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt32DefObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public List<ICFBamUInt32DefObj> readUInt32DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt32DefByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt32DefObj> readUInt32DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readUInt32DefByCodeVisIdx";
	...
	public List<ICFBamUInt32DefObj> readUInt32DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt32DefByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt32DefObj> readUInt32DefByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readUInt32DefByScopeCodeVisIdx";
	...
	public List<ICFBamUInt32DefObj> readCachedUInt32DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt32DefByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamUInt32DefObj> arrayList = new ArrayList<ICFBamUInt32DefObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamUInt32DefObj> readCachedUInt32DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt32DefByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeUInt32DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt32DefByCodeVisIdx";
		ICFBamUInt32DefObj obj;
		List<ICFBamUInt32DefObj> arrayList = readCachedUInt32DefByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt32DefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeUInt32DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt32DefByScopeCodeVisIdx";
		ICFBamUInt32DefObj obj;
		List<ICFBamUInt32DefObj> arrayList = readCachedUInt32DefByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt32DefObj> arrayIter = arrayList.iterator();
	...
	public void deleteUInt32DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt32DefObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt32Def().deleteUInt32DefByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamUInt32DefObj> iter = dict.values().iterator();
			ICFBamUInt32DefObj obj;
			List<ICFBamUInt32DefObj> toForget = new LinkedList<ICFBamUInt32DefObj>();
		...
		deepDisposeUInt32DefByCodeVisIdx( CodeVis );
	}

	public void deleteUInt32DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt32DefObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt32Def().deleteUInt32DefByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamUInt32DefObj> iter = dict.values().iterator();
		...
		deepDisposeUInt32DefByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
