// Description: Java 11 Instance Edit Object interface for CFBam Uuid6Type.
...
public interface ICFBamUuid6TypeEditObj
	extends ICFBamUuid6TypeObj,
		ICFBamUuid6DefEditObj
{
	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamUuid6TypeObj.
	 */
	ICFBamUuid6TypeObj getOrigAsUuid6Type();
