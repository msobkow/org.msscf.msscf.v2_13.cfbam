// Description: Java 11 edit object instance implementation for CFBam SchemaRole.
	...
	implements ICFBamSchemaRoleEditObj
{
	...
	public String getClassCode() {
		return( CFBamSchemaRoleObj.CLASS_CODE );
	}
	...
	public CFBamRoleDefBuff getBuff() {
		if( buff == null ) {
			buff = ((ICFBamSchema)getOrigAsSchemaRole().getSchema().getBackingStore()).getFactorySchemaRole().newBuff();
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsSchemaRole().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getPKey().getRequiredTenantId(),
					getSchemaRoleBuff().getRequiredSchemaDefId() );
				requiredContainerSchemaDef = obj;
				if( obj != null ) {
					getSchemaRoleBuff().setRequiredTenantId( obj.getRequiredTenantId() );
					getSchemaRoleBuff().setRequiredSchemaDefId( obj.getRequiredId() );
					requiredContainerSchemaDef = obj;
				}
			}
		}
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
			...
			if( value != null ) {
				...
				getSchemaRoleBuff().setRequiredTenantId( value.getRequiredTenantId() );
				getSchemaRoleBuff().setRequiredSchemaDefId( value.getRequiredId() );
			}
	...
	public void copyBuffToOrig() {
		CFBamSchemaRoleBuff origBuff = getOrigAsSchemaRole().getSchemaRoleBuff();
		CFBamSchemaRoleBuff myBuff = getSchemaRoleBuff();
		origBuff.set( myBuff );
	}
