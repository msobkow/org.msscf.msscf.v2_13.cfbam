// Description: Java 11 implementation of a DbKeyHash224Type history buffer object.
...
public class CFBamDbKeyHash224TypeHBuff
	extends CFBamDbKeyHash224DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash224TypeHBuff() {
		super();
		requiredSchemaDefId = CFBamDbKeyHash224TypeBuff.SCHEMADEFID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash224TypeBuff.CLASS_CODE );
	}
	...
	public void setRequiredSchemaDefId( long value ) {
		if( value < CFBamDbKeyHash224TypeBuff.SCHEMADEFID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSchemaDefId",
				1,
				"value",
				value,
				CFBamDbKeyHash224TypeBuff.SCHEMADEFID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash224TypeHBuff ) {
			CFBamDbKeyHash224TypeHBuff rhs = (CFBamDbKeyHash224TypeHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash224TypeBuff ) {
			CFBamDbKeyHash224TypeBuff rhs = (CFBamDbKeyHash224TypeBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash224TypeBySchemaIdxKey ) {
			CFBamDbKeyHash224TypeBySchemaIdxKey rhs = (CFBamDbKeyHash224TypeBySchemaIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredSchemaDefId() != rhs.getRequiredSchemaDefId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash224TypeBuff ) {
			setDbKeyHash224TypeBuff( (CFBamDbKeyHash224TypeBuff)src );
		}
		else {
	...
	public void setDbKeyHash224TypeBuff( CFBamDbKeyHash224TypeBuff src ) {
		super.setDbKeyHash224DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash224TypeHBuff ) {
			setDbKeyHash224TypeBuff( (CFBamDbKeyHash224TypeHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash224TypeHBuff" );
		}
	}

	public void setDbKeyHash224TypeBuff( CFBamDbKeyHash224TypeHBuff src ) {
		super.setDbKeyHash224DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}
}
