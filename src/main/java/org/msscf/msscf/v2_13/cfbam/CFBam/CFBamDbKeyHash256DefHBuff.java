// Description: Java 11 implementation of a DbKeyHash256Def history buffer object.
...
public class CFBamDbKeyHash256DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash256DefHBuff() {
		super();
		optionalInitValue = null;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash256DefBuff.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash256DefHBuff ) {
			CFBamDbKeyHash256DefHBuff rhs = (CFBamDbKeyHash256DefHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash256DefBuff ) {
			CFBamDbKeyHash256DefBuff rhs = (CFBamDbKeyHash256DefBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash256DefBuff ) {
			setDbKeyHash256DefBuff( (CFBamDbKeyHash256DefBuff)src );
		}
		else {
	...
	public void setDbKeyHash256DefBuff( CFBamDbKeyHash256DefBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash256DefHBuff ) {
			setDbKeyHash256DefBuff( (CFBamDbKeyHash256DefHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash256DefHBuff" );
		}
	}

	public void setDbKeyHash256DefBuff( CFBamDbKeyHash256DefHBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}
}
