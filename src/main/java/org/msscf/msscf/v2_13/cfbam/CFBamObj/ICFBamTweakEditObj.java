// Description: Java 11 Instance Edit Object interface for CFBam Tweak.
...
public interface ICFBamTweakEditObj
	extends ICFBamTweakObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamTweakObj.
	 */
	ICFBamTweakObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamTweakObj.
	 */
	ICFBamTweakObj getOrigAsTweak();
	 ...
	 */
	ICFBamTweakObj create();

	/*
	 *	Update the instance.
	 */
	CFBamTweakEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFBamTweakEditObj deleteInstance();
	 ...
	 *
	 *	@param	value	the String value of the attribute TweakGelText.
	 */
	...
	/**
	 *	Get the ICFBamScopeObj instance referenced by the ScopeDef key.
	 *
	 *	@return	The ICFBamScopeObj instance referenced by the ScopeDef key.
	 */
	 ...
	 */
	void setRequiredContainerScopeDef( ICFBamScopeObj value );
