// Description: Java 11 implementation of a SchemaTweak by SchemaIdx index key object.
...
public class CFBamSchemaTweakBySchemaIdxKey
	implements Comparable<Object>,
		Serializable
{
	protected long requiredTenantId;
	protected long requiredSchemaDefId;
	public CFBamSchemaTweakBySchemaIdxKey() {
		requiredTenantId = CFBamSchemaTweakBuff.TENANTID_INIT_VALUE;
	...
	public void setRequiredTenantId( long value ) {
		if( value < CFBamSchemaTweakBuff.TENANTID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTenantId",
				1,
				"value",
				value,
				CFBamSchemaTweakBuff.TENANTID_MIN_VALUE );
		}
	...
	public String toString() {
		String ret = "<CFBamSchemaTweakBySchemaIdx"
