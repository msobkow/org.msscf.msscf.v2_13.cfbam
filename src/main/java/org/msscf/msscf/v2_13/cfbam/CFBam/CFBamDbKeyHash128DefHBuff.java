// Description: Java 11 implementation of a DbKeyHash128Def history buffer object.
...
public class CFBamDbKeyHash128DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash128DefHBuff() {
		super();
		optionalInitValue = null;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash128DefBuff.CLASS_CODE );
	}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash128DefHBuff ) {
			CFBamDbKeyHash128DefHBuff rhs = (CFBamDbKeyHash128DefHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash128DefBuff ) {
			CFBamDbKeyHash128DefBuff rhs = (CFBamDbKeyHash128DefBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash128DefBuff ) {
			setDbKeyHash128DefBuff( (CFBamDbKeyHash128DefBuff)src );
		}
		else {
	...
	public void setDbKeyHash128DefBuff( CFBamDbKeyHash128DefBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash128DefHBuff ) {
			setDbKeyHash128DefBuff( (CFBamDbKeyHash128DefHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash128DefHBuff" );
		}
	}

	public void setDbKeyHash128DefBuff( CFBamDbKeyHash128DefHBuff src ) {
		super.setAtomBuff( src );
		setOptionalInitValue( src.getOptionalInitValue() );
	}
}
