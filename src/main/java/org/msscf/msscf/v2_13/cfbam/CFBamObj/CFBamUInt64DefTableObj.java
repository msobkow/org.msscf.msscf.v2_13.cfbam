	...
	implements ICFBamUInt64DefTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt64DefObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt64DefObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamUInt64DefObj realiseUInt64Def( ICFBamUInt64DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt64DefObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt64DefObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public List<ICFBamUInt64DefObj> readUInt64DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt64DefByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt64DefObj> readUInt64DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readUInt64DefByCodeVisIdx";
	...
	public List<ICFBamUInt64DefObj> readUInt64DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt64DefByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt64DefObj> readUInt64DefByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readUInt64DefByScopeCodeVisIdx";
	...
	public List<ICFBamUInt64DefObj> readCachedUInt64DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt64DefByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamUInt64DefObj> arrayList = new ArrayList<ICFBamUInt64DefObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamUInt64DefObj> readCachedUInt64DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt64DefByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeUInt64DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt64DefByCodeVisIdx";
		ICFBamUInt64DefObj obj;
		List<ICFBamUInt64DefObj> arrayList = readCachedUInt64DefByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt64DefObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeUInt64DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt64DefByScopeCodeVisIdx";
		ICFBamUInt64DefObj obj;
		List<ICFBamUInt64DefObj> arrayList = readCachedUInt64DefByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt64DefObj> arrayIter = arrayList.iterator();
	...
	public void deleteUInt64DefByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt64DefObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt64Def().deleteUInt64DefByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamUInt64DefObj> iter = dict.values().iterator();
			ICFBamUInt64DefObj obj;
			List<ICFBamUInt64DefObj> toForget = new LinkedList<ICFBamUInt64DefObj>();
		...
		deepDisposeUInt64DefByCodeVisIdx( CodeVis );
	}

	public void deleteUInt64DefByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt64DefObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt64Def().deleteUInt64DefByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamUInt64DefObj> iter = dict.values().iterator();
		...
		deepDisposeUInt64DefByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
