	...
	ICFIntTenantTable
{
	...
	/**
	 *	Get the next RoleIdGen id generator value.
	 *
	 *	@param	PKey	The primary key of the Tenant instance generating the id.
	 *
	 *	@throws CFLibNotSupportedException thrown by client-side implementations.
	 ...
	 *	@return The next id value as generated by the cluster database.
	 */
	long nextRoleIdGen( CFSecAuthorization Authorization,
		CFSecTenantPKey PKey );
	...
	/**
	 *	Get the next TweakIdGen id generator value.
	 *
	 *	@param	PKey	The primary key of the Tenant instance generating the id.
	 *
	 *	@throws CFLibNotSupportedException thrown by client-side implementations.
	 ...
	 *	@return The next id value as generated by the cluster database.
	 */
	long nextTweakIdGen( CFSecAuthorization Authorization,
		CFSecTenantPKey PKey );
