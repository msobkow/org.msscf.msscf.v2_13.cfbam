// Description: Java 11 implementation of a IndexTweak by IndexIdx index key object.
...
public class CFBamIndexTweakByIndexIdxKey
	implements Comparable<Object>,
		Serializable
{
	protected long requiredTenantId;
	protected long requiredIndexId;
	public CFBamIndexTweakByIndexIdxKey() {
		requiredTenantId = CFBamIndexTweakBuff.TENANTID_INIT_VALUE;
	...
	public void setRequiredTenantId( long value ) {
		if( value < CFBamIndexTweakBuff.TENANTID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTenantId",
				1,
				"value",
				value,
				CFBamIndexTweakBuff.TENANTID_MIN_VALUE );
		}
	...
	public String toString() {
		String ret = "<CFBamIndexTweakByIndexIdx"
