// Description: Java 11 base object instance implementation for CFBam DbKeyHash384Gen.
	...
	implements ICFBamDbKeyHash384GenObj
{
	...
	public ICFBamValueObj realise() {
		ICFBamDbKeyHash384GenObj retobj = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().realiseDbKeyHash384Gen(
			(ICFBamDbKeyHash384GenObj)this );
		return( (ICFBamValueObj)retobj );
	}

	public void forget() {
		((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().reallyDeepDisposeDbKeyHash384Gen( (ICFBamDbKeyHash384GenObj)this );
	}

	public ICFBamValueObj read() {
		ICFBamDbKeyHash384GenObj retobj = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().readDbKeyHash384GenByIdIdx( getPKey().getRequiredTenantId(),
	...
	public ICFBamValueObj moveUp() {
		ICFBamDbKeyHash384GenObj retobj = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().moveUpDbKeyHash384Gen( this );
		return( (ICFBamValueObj)retobj );
	}

	public ICFBamValueObj moveDown() {
		ICFBamDbKeyHash384GenObj retobj = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().moveDownDbKeyHash384Gen( this );
		return( (ICFBamValueObj)retobj );
	}

	public ICFBamDbKeyHash384GenTableObj getDbKeyHash384GenTable() {
		return( ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj() );
	}

	public CFBamValueBuff getBuff() {
		if( buff == null ) {
			if( isNew ) {
				buff = ((ICFBamSchema)schema.getBackingStore()).getFactoryDbKeyHash384Gen().newBuff();
			}
			else {
				// Read the data buff via the backing store
				buff = ((ICFBamSchema)schema.getBackingStore()).getTableDbKeyHash384Gen().readDerivedByIdIdx( ((ICFBamSchemaObj)schema).getAuthorization(),
	...
	public void setBuff( CFBamValueBuff value ) {
		if( ! ( ( value == null ) || ( value instanceof CFBamDbKeyHash384GenBuff ) ) ) {
	...
	public ICFBamValueEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().lockDbKeyHash384Gen( getPKey() );
		}
		edit = ((ICFBamSchemaObj)schema).getDbKeyHash384GenTableObj().newEditInstance( lockobj );
	...
	public ICFBamTableObj getOptionalLookupDispenser( boolean forceRead ) {
		if( ( optionalLookupDispenser == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				optionalLookupDispenser = ((ICFBamSchemaObj)schema).getTableTableObj().readTableByIdIdx( getDbKeyHash384GenBuff().getOptionalDispenserTenantId(),
					getDbKeyHash384GenBuff().getOptionalDispenserId(), forceRead );
			}
		}
