// Description: Java 11 implementation of a DbKeyHash160Gen buffer object.
...
public class CFBamDbKeyHash160GenBuff
	extends CFBamDbKeyHash160TypeBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash160GenBuff() {
		super();
	...
	public void setRequiredBlockSize( int value ) {
		if( value < CFBamDbKeyHash160GenBuff.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash160GenBuff.BLOCKSIZE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash160GenBuff.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash160GenBuff.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash160GenBuff ) {
			CFBamDbKeyHash160GenBuff rhs = (CFBamDbKeyHash160GenBuff)obj;
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash160GenBuff ) {
			setDbKeyHash160GenBuff( (CFBamDbKeyHash160GenBuff)src );
		}
		else {
	...
	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash160GenHBuff ) {
			setDbKeyHash160GenBuff( (CFBamDbKeyHash160GenHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
