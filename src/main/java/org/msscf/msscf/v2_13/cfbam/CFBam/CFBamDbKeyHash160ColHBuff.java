// Description: Java 11 implementation of a DbKeyHash160Col history buffer object.
...
public class CFBamDbKeyHash160ColHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash160ColHBuff() {
		super();
		requiredTableId = CFBamDbKeyHash160ColBuff.TABLEID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash160ColBuff.CLASS_CODE );
	}
	...
	public void setRequiredTableId( long value ) {
		if( value < CFBamDbKeyHash160ColBuff.TABLEID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTableId",
				1,
				"value",
				value,
				CFBamDbKeyHash160ColBuff.TABLEID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash160ColHBuff ) {
			CFBamDbKeyHash160ColHBuff rhs = (CFBamDbKeyHash160ColHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash160ColBuff ) {
			CFBamDbKeyHash160ColBuff rhs = (CFBamDbKeyHash160ColBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash160ColByTableIdxKey ) {
			CFBamDbKeyHash160ColByTableIdxKey rhs = (CFBamDbKeyHash160ColByTableIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredTableId() != rhs.getRequiredTableId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash160ColBuff ) {
			setDbKeyHash160ColBuff( (CFBamDbKeyHash160ColBuff)src );
		}
		else {
	...
	public void setDbKeyHash160ColBuff( CFBamDbKeyHash160ColBuff src ) {
		super.setDbKeyHash160DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash160ColHBuff ) {
			setDbKeyHash160ColBuff( (CFBamDbKeyHash160ColHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash160ColHBuff" );
		}
	}

	public void setDbKeyHash160ColBuff( CFBamDbKeyHash160ColHBuff src ) {
		super.setDbKeyHash160DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}
}
