// Description: Java 11 implementation of a DbKeyHash224Gen history buffer object.
...
public class CFBamDbKeyHash224GenHBuff
	extends CFBamDbKeyHash224TypeHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash224GenHBuff() {
		super();
		optionalDispenserTenantId = null;
		optionalDispenserId = null;
		requiredSlice = CFBamDbKeyHash224GenBuff.SLICE_INIT_VALUE;
		requiredBlockSize = CFBamDbKeyHash224GenBuff.BLOCKSIZE_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash224GenBuff.CLASS_CODE );
	}
	...
	public void setOptionalDispenserTenantId( Long value ) {
		...
		else if( value < CFBamDbKeyHash224GenBuff.DISPENSERTENANTID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserTenantId",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.DISPENSERTENANTID_MIN_VALUE );
		}
		else {
	...
	public void setOptionalDispenserId( Long value ) {
		...
		else if( value < CFBamDbKeyHash224GenBuff.DISPENSERID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setOptionalDispenserId",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.DISPENSERID_MIN_VALUE );
		}
		else {
	...
	public void setRequiredSlice( short value ) {
		if( value < CFBamDbKeyHash224GenBuff.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.SLICE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash224GenBuff.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredSlice",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.SLICE_MAX_VALUE );
		}
		requiredSlice = value;
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( value < CFBamDbKeyHash224GenBuff.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.BLOCKSIZE_MIN_VALUE );
		}
		if( value > CFBamDbKeyHash224GenBuff.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				"setRequiredBlockSize",
				1,
				"value",
				value,
				CFBamDbKeyHash224GenBuff.BLOCKSIZE_MAX_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash224GenHBuff ) {
			CFBamDbKeyHash224GenHBuff rhs = (CFBamDbKeyHash224GenHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash224GenBuff ) {
			CFBamDbKeyHash224GenBuff rhs = (CFBamDbKeyHash224GenBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash224GenByDispIdxKey ) {
			CFBamDbKeyHash224GenByDispIdxKey rhs = (CFBamDbKeyHash224GenByDispIdxKey)obj;
			if( getOptionalDispenserTenantId() != null ) {
				if( rhs.getOptionalDispenserTenantId() != null ) {
					if( ! getOptionalDispenserTenantId().equals( rhs.getOptionalDispenserTenantId() ) ) {
						return( false );
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash224GenBuff ) {
			setDbKeyHash224GenBuff( (CFBamDbKeyHash224GenBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				...
				"src",
				src,
				"CFBamDbKeyHash224GenBuff" );
		}
	}

	public void setDbKeyHash224GenBuff( CFBamDbKeyHash224GenBuff src ) {
		super.setDbKeyHash224TypeBuff( src );
	...
	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash224GenHBuff ) {
			setDbKeyHash224GenBuff( (CFBamDbKeyHash224GenHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash224GenHBuff" );
		}
	}

	public void setDbKeyHash224GenBuff( CFBamDbKeyHash224GenHBuff src ) {
		super.setDbKeyHash224TypeBuff( src );
		setOptionalDispenserTenantId( src.getOptionalDispenserTenantId() );
		setOptionalDispenserId( src.getOptionalDispenserId() );
		setRequiredSlice( src.getRequiredSlice() );
