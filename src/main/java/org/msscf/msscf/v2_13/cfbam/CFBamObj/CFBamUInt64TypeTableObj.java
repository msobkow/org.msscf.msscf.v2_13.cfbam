	...
	implements ICFBamUInt64TypeTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt64TypeObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamUInt64TypeObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamUInt64TypeObj realiseUInt64Type( ICFBamUInt64TypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt64TypeObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamUInt64TypeObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public List<ICFBamUInt64TypeObj> readUInt64TypeByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt64TypeByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt64TypeObj> readUInt64TypeByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readUInt64TypeByCodeVisIdx";
	...
	public List<ICFBamUInt64TypeObj> readUInt64TypeByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readUInt64TypeByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamUInt64TypeObj> readUInt64TypeByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readUInt64TypeByScopeCodeVisIdx";
	...
	public List<ICFBamUInt64TypeObj> readCachedUInt64TypeByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt64TypeByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamUInt64TypeObj> arrayList = new ArrayList<ICFBamUInt64TypeObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamUInt64TypeObj> readCachedUInt64TypeByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedUInt64TypeByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeUInt64TypeByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt64TypeByCodeVisIdx";
		ICFBamUInt64TypeObj obj;
		List<ICFBamUInt64TypeObj> arrayList = readCachedUInt64TypeByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt64TypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeUInt64TypeByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeUInt64TypeByScopeCodeVisIdx";
		ICFBamUInt64TypeObj obj;
		List<ICFBamUInt64TypeObj> arrayList = readCachedUInt64TypeByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamUInt64TypeObj> arrayIter = arrayList.iterator();
	...
	public void deleteUInt64TypeByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt64TypeObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt64Type().deleteUInt64TypeByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamUInt64TypeObj> iter = dict.values().iterator();
			ICFBamUInt64TypeObj obj;
			List<ICFBamUInt64TypeObj> toForget = new LinkedList<ICFBamUInt64TypeObj>();
		...
		deepDisposeUInt64TypeByCodeVisIdx( CodeVis );
	}

	public void deleteUInt64TypeByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamUInt64TypeObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableUInt64Type().deleteUInt64TypeByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamUInt64TypeObj> iter = dict.values().iterator();
		...
		deepDisposeUInt64TypeByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
