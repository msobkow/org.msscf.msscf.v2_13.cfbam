	...
	implements ICFBamStringColTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamStringColObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamStringColObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamStringColObj realiseStringCol( ICFBamStringColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamStringColObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamStringColObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public ICFBamStringColObj createStringCol( ICFBamStringColObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableStringCol().createStringCol(
			...
			buff );
		obj.copyBuffToPKey();
		if( obj.getPKey().getClassCode().equals( "a87e" ) ) {
	...
	public List<ICFBamStringColObj> readStringColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readStringColByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamStringColObj> readStringColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readStringColByCodeVisIdx";
	...
	public List<ICFBamStringColObj> readStringColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readStringColByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamStringColObj> readStringColByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readStringColByScopeCodeVisIdx";
	...
	public List<ICFBamStringColObj> readCachedStringColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedStringColByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamStringColObj> arrayList = new ArrayList<ICFBamStringColObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamStringColObj> readCachedStringColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedStringColByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeStringColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeStringColByCodeVisIdx";
		ICFBamStringColObj obj;
		List<ICFBamStringColObj> arrayList = readCachedStringColByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamStringColObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeStringColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeStringColByScopeCodeVisIdx";
		ICFBamStringColObj obj;
		List<ICFBamStringColObj> arrayList = readCachedStringColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamStringColObj> arrayIter = arrayList.iterator();
	...
	public ICFBamStringColObj updateStringCol( ICFBamStringColObj Obj ) {
		...
		if( Obj.getClassCode().equals( "a87e" ) ) {
			obj = (ICFBamStringColObj)Obj.realise();
		}
		obj.endEdit();
		return( obj );
	...
	public void deleteStringColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamStringColObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableStringCol().deleteStringColByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamStringColObj> iter = dict.values().iterator();
			ICFBamStringColObj obj;
			List<ICFBamStringColObj> toForget = new LinkedList<ICFBamStringColObj>();
		...
		deepDisposeStringColByCodeVisIdx( CodeVis );
	}

	public void deleteStringColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamStringColObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableStringCol().deleteStringColByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamStringColObj> iter = dict.values().iterator();
		...
		deepDisposeStringColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
