// Description: Java 11 implementation of a RoleDef history buffer object.
...
public class CFBamRoleDefHBuff
		...
		Serializable
{
	...
	public String getClassCode() {
		return( CFBamRoleDefBuff.CLASS_CODE );
	}
