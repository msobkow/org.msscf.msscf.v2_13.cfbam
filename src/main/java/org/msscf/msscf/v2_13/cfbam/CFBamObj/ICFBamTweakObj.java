// Description: Java 11 Object interface for CFBam Tweak.
...
public interface ICFBamTweakObj
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFBamTweakObj instance which should be subsequently referenced.
	 */
	ICFBamTweakObj realise();
	 ...
	 *
	 *	@return	ICFBamTweakObj the reference to the cached or read (realised) instance.
	 */
	ICFBamTweakObj read();
	 ...
	 *	@return	ICFBamTweakObj the reference to the cached or read (realised) instance.
	 */
	ICFBamTweakObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Tweak instance.
	 *
	 *	@return	The newly locked ICFBamTweakEditObj edition of this instance.
	 */
	ICFBamTweakEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFBamTweakEditObj edition of this instance.
	 */
	ICFBamTweakEditObj getEdit();

	/**
	 *	Get the current edition of this Tweak instance as a ICFBamTweakEditObj.
	 *
	 *	@return	The ICFBamTweakEditObj edition of this instance.
	 */
	ICFBamTweakEditObj getEditAsTweak();

	/**
	 *	Get the ICFBamTweakTableObj table cache which manages this instance.
	 *
	 *	@return	ICFBamTweakTableObj table cache which manages this instance.
	 */
	ICFBamTweakTableObj getTweakTable();
	...
	/**
	 *	Get the CFBamTweakBuff instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	CFBamTweakBuff instance which currently backs this object.
	 */
	CFBamTweakBuff getBuff();

	/**
	 *	Internal use only.
	 */
	void setBuff( CFBamTweakBuff value );
	 ...
	 *	@return	CFBamTweakBuff instance which currently backs this object.
	 */
	CFBamTweakBuff getTweakBuff();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	CFBamTweakPKey primary key for this instance.
	 */
	CFBamTweakPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param CFBamTweakPKey primary key value for this instance.
	 */
	void setPKey( CFBamTweakPKey value );
