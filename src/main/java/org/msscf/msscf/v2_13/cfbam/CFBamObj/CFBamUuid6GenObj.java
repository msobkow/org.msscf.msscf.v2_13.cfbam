// Description: Java 11 base object instance implementation for CFBam Uuid6Gen.
	...
	implements ICFBamUuid6GenObj
{
	...
	public ICFBamValueObj realise() {
		ICFBamUuid6GenObj retobj = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().realiseUuid6Gen(
			(ICFBamUuid6GenObj)this );
		return( (ICFBamValueObj)retobj );
	}

	public void forget() {
		((ICFBamSchemaObj)schema).getUuid6GenTableObj().reallyDeepDisposeUuid6Gen( (ICFBamUuid6GenObj)this );
	}

	public ICFBamValueObj read() {
		ICFBamUuid6GenObj retobj = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().readUuid6GenByIdIdx( getPKey().getRequiredTenantId(),
	...
	public ICFBamValueObj moveUp() {
		ICFBamUuid6GenObj retobj = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().moveUpUuid6Gen( this );
		return( (ICFBamValueObj)retobj );
	}

	public ICFBamValueObj moveDown() {
		ICFBamUuid6GenObj retobj = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().moveDownUuid6Gen( this );
		return( (ICFBamValueObj)retobj );
	}

	public ICFBamUuid6GenTableObj getUuid6GenTable() {
		return( ((ICFBamSchemaObj)schema).getUuid6GenTableObj() );
	}

	public CFBamValueBuff getBuff() {
		if( buff == null ) {
			if( isNew ) {
				buff = ((ICFBamSchema)schema.getBackingStore()).getFactoryUuid6Gen().newBuff();
			}
			else {
				// Read the data buff via the backing store
				buff = ((ICFBamSchema)schema.getBackingStore()).getTableUuid6Gen().readDerivedByIdIdx( ((ICFBamSchemaObj)schema).getAuthorization(),
	...
	public void setBuff( CFBamValueBuff value ) {
		if( ! ( ( value == null ) || ( value instanceof CFBamUuid6GenBuff ) ) ) {
	...
	public ICFBamValueEditObj beginEdit() {
		...
		ICFBamUuid6GenObj lockobj;
		if( getIsNew() ) {
			lockobj = (ICFBamUuid6GenObj)this;
		}
		else {
			lockobj = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().lockUuid6Gen( getPKey() );
		}
		edit = ((ICFBamSchemaObj)schema).getUuid6GenTableObj().newEditInstance( lockobj );
		return( (ICFBamValueEditObj)edit );
	}

	public ICFBamUuid6GenEditObj getEditAsUuid6Gen() {
		return( (ICFBamUuid6GenEditObj)edit );
	}
