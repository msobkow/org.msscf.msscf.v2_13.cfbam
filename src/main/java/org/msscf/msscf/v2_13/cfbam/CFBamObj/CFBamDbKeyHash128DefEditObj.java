// Description: Java 11 edit object instance implementation for CFBam DbKeyHash128Def.
	...
	implements ICFBamDbKeyHash128DefEditObj
{
	...
	public String getClassCode() {
		return( CFBamDbKeyHash128DefObj.CLASS_CODE );
	}
	...
	public CFBamValueBuff getBuff() {
		if( buff == null ) {
			buff = ((ICFBamSchema)getOrigAsDbKeyHash128Def().getSchema().getBackingStore()).getFactoryDbKeyHash128Def().newBuff();
	...
	public void setOptionalInitValue( String value ) {
		if( getDbKeyHash128DefBuff().getOptionalInitValue() != value ) {
			getDbKeyHash128DefBuff().setOptionalInitValue( value );
		}
	}

	public void copyBuffToOrig() {
		CFBamDbKeyHash128DefBuff origBuff = getOrigAsDbKeyHash128Def().getDbKeyHash128DefBuff();
		CFBamDbKeyHash128DefBuff myBuff = getDbKeyHash128DefBuff();
		origBuff.set( myBuff );
	}
