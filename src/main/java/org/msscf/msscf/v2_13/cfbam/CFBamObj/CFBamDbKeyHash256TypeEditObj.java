// Description: Java 11 edit object instance implementation for CFBam DbKeyHash256Type.
	...
	implements ICFBamDbKeyHash256TypeEditObj
{
	...
	public String getClassCode() {
		return( CFBamDbKeyHash256TypeObj.CLASS_CODE );
	}
	...
	public CFBamValueBuff getBuff() {
		if( buff == null ) {
			buff = ((ICFBamSchema)getOrigAsDbKeyHash256Type().getSchema().getBackingStore()).getFactoryDbKeyHash256Type().newBuff();
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsDbKeyHash256Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getPKey().getRequiredTenantId(),
					getDbKeyHash256TypeBuff().getRequiredSchemaDefId() );
				requiredContainerSchemaDef = obj;
				if( obj != null ) {
					getDbKeyHash256TypeBuff().setRequiredTenantId( obj.getRequiredTenantId() );
					getDbKeyHash256TypeBuff().setRequiredSchemaDefId( obj.getRequiredId() );
					requiredContainerSchemaDef = obj;
				}
			}
		}
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
			if( buff == null ) {
				getDbKeyHash256TypeBuff();
			}
			if( value != null ) {
				getPKey().setRequiredTenantId( value.getRequiredTenantId() );
				getDbKeyHash256TypeBuff().setRequiredTenantId( value.getRequiredTenantId() );
				getDbKeyHash256TypeBuff().setRequiredSchemaDefId( value.getRequiredId() );
			}
	...
	public void copyBuffToOrig() {
		CFBamDbKeyHash256TypeBuff origBuff = getOrigAsDbKeyHash256Type().getDbKeyHash256TypeBuff();
		CFBamDbKeyHash256TypeBuff myBuff = getDbKeyHash256TypeBuff();
		origBuff.set( myBuff );
	}
