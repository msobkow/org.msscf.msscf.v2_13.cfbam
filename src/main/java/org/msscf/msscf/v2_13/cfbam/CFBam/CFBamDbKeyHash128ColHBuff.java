// Description: Java 11 implementation of a DbKeyHash128Col history buffer object.
...
public class CFBamDbKeyHash128ColHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash128ColHBuff() {
		super();
		requiredTableId = CFBamDbKeyHash128ColBuff.TABLEID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash128ColBuff.CLASS_CODE );
	}
	...
	public void setRequiredTableId( long value ) {
		if( value < CFBamDbKeyHash128ColBuff.TABLEID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTableId",
				1,
				"value",
				value,
				CFBamDbKeyHash128ColBuff.TABLEID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash128ColHBuff ) {
			CFBamDbKeyHash128ColHBuff rhs = (CFBamDbKeyHash128ColHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash128ColBuff ) {
			CFBamDbKeyHash128ColBuff rhs = (CFBamDbKeyHash128ColBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash128ColByTableIdxKey ) {
			CFBamDbKeyHash128ColByTableIdxKey rhs = (CFBamDbKeyHash128ColByTableIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredTableId() != rhs.getRequiredTableId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash128ColBuff ) {
			setDbKeyHash128ColBuff( (CFBamDbKeyHash128ColBuff)src );
		}
		else {
	...
	public void setDbKeyHash128ColBuff( CFBamDbKeyHash128ColBuff src ) {
		super.setDbKeyHash128DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash128ColHBuff ) {
			setDbKeyHash128ColBuff( (CFBamDbKeyHash128ColHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash128ColHBuff" );
		}
	}

	public void setDbKeyHash128ColBuff( CFBamDbKeyHash128ColHBuff src ) {
		super.setDbKeyHash128DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}
}
