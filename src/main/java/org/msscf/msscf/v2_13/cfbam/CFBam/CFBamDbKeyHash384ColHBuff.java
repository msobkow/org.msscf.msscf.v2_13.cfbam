// Description: Java 11 implementation of a DbKeyHash384Col history buffer object.
...
public class CFBamDbKeyHash384ColHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash384ColHBuff() {
		super();
		requiredTableId = CFBamDbKeyHash384ColBuff.TABLEID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash384ColBuff.CLASS_CODE );
	}
	...
	public void setRequiredTableId( long value ) {
		if( value < CFBamDbKeyHash384ColBuff.TABLEID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTableId",
				1,
				"value",
				value,
				CFBamDbKeyHash384ColBuff.TABLEID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash384ColHBuff ) {
			CFBamDbKeyHash384ColHBuff rhs = (CFBamDbKeyHash384ColHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash384ColBuff ) {
			CFBamDbKeyHash384ColBuff rhs = (CFBamDbKeyHash384ColBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash384ColByTableIdxKey ) {
			CFBamDbKeyHash384ColByTableIdxKey rhs = (CFBamDbKeyHash384ColByTableIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredTableId() != rhs.getRequiredTableId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash384ColBuff ) {
			setDbKeyHash384ColBuff( (CFBamDbKeyHash384ColBuff)src );
		}
		else {
	...
	public void setDbKeyHash384ColBuff( CFBamDbKeyHash384ColBuff src ) {
		super.setDbKeyHash384DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash384ColHBuff ) {
			setDbKeyHash384ColBuff( (CFBamDbKeyHash384ColHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash384ColHBuff" );
		}
	}

	public void setDbKeyHash384ColBuff( CFBamDbKeyHash384ColHBuff src ) {
		super.setDbKeyHash384DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}
}
