	...
	implements ICFBamInt32ColTableObj
{
	...
	private Map< CFBamValueByCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamInt32ColObj > > indexByCodeVisIdx;
	private Map< CFBamValueByScopeCodeVisIdxKey,
		Map<CFBamValuePKey, ICFBamInt32ColObj > > indexByScopeCodeVisIdx;
	...
	public ICFBamInt32ColObj realiseInt32Col( ICFBamInt32ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamInt32ColObj > mapCodeVisIdx = indexByCodeVisIdx.get( keyCodeVisIdx );
			...
			if( indexByScopeCodeVisIdx != null ) {
				...
				Map<CFBamValuePKey, ICFBamInt32ColObj > mapScopeCodeVisIdx = indexByScopeCodeVisIdx.get( keyScopeCodeVisIdx );
	...
	public ICFBamInt32ColObj createInt32Col( ICFBamInt32ColObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableInt32Col().createInt32Col(
			...
			buff );
		obj.copyBuffToPKey();
		if( obj.getPKey().getClassCode().equals( "a879" ) ) {
	...
	public List<ICFBamInt32ColObj> readInt32ColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readInt32ColByCodeVisIdx( CodeVis,
			false ) );
	}
	...
	public List<ICFBamInt32ColObj> readInt32ColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis,
		boolean forceRead )
	{
		final String S_ProcName = "readInt32ColByCodeVisIdx";
	...
	public List<ICFBamInt32ColObj> readInt32ColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		return( readInt32ColByScopeCodeVisIdx( TenantId,
			ScopeId,
			CodeVis,
			false ) );
	}
	...
	public List<ICFBamInt32ColObj> readInt32ColByScopeCodeVisIdx( long TenantId,
		...
		boolean forceRead )
	{
		final String S_ProcName = "readInt32ColByScopeCodeVisIdx";
	...
	public List<ICFBamInt32ColObj> readCachedInt32ColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedInt32ColByCodeVisIdx";
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		ArrayList<ICFBamInt32ColObj> arrayList = new ArrayList<ICFBamInt32ColObj>();
		if( indexByCodeVisIdx != null ) {
	...
	public List<ICFBamInt32ColObj> readCachedInt32ColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "readCachedInt32ColByScopeCodeVisIdx";
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		key.setRequiredTenantId( TenantId );
		key.setRequiredScopeId( ScopeId );
		key.setRequiredCodeVis( CodeVis );
	...
	public void deepDisposeInt32ColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeInt32ColByCodeVisIdx";
		ICFBamInt32ColObj obj;
		List<ICFBamInt32ColObj> arrayList = readCachedInt32ColByCodeVisIdx( CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamInt32ColObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeInt32ColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		final String S_ProcName = "deepDisposeInt32ColByScopeCodeVisIdx";
		ICFBamInt32ColObj obj;
		List<ICFBamInt32ColObj> arrayList = readCachedInt32ColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamInt32ColObj> arrayIter = arrayList.iterator();
	...
	public ICFBamInt32ColObj updateInt32Col( ICFBamInt32ColObj Obj ) {
		...
		((ICFBamSchema)schema.getBackingStore()).getTableInt32Col().updateInt32Col( schema.getAuthorization(),
			Obj.getInt32ColBuff() );
		if( Obj.getClassCode().equals( "a879" ) ) {
			obj = (ICFBamInt32ColObj)Obj.realise();
		}
		obj.endEdit();
		return( obj );
	...
	public void deleteInt32ColByCodeVisIdx( ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByCodeVisIdx == null ) {
		...
		if( indexByCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamInt32ColObj> dict = indexByCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableInt32Col().deleteInt32ColByCodeVisIdx( schema.getAuthorization(),
				CodeVis );
			Iterator<ICFBamInt32ColObj> iter = dict.values().iterator();
			ICFBamInt32ColObj obj;
			List<ICFBamInt32ColObj> toForget = new LinkedList<ICFBamInt32ColObj>();
		...
		deepDisposeInt32ColByCodeVisIdx( CodeVis );
	}

	public void deleteInt32ColByScopeCodeVisIdx( long TenantId,
		long ScopeId,
		ICFBamSchema.CodeVisibilityEnum CodeVis )
	{
		CFBamValueByScopeCodeVisIdxKey key = ((ICFBamSchema)schema.getBackingStore()).getFactoryValue().newScopeCodeVisIdxKey();
		...
		if( indexByScopeCodeVisIdx.containsKey( key ) ) {
			Map<CFBamValuePKey, ICFBamInt32ColObj> dict = indexByScopeCodeVisIdx.get( key );
			((ICFBamSchema)schema.getBackingStore()).getTableInt32Col().deleteInt32ColByScopeCodeVisIdx( schema.getAuthorization(),
				TenantId,
				ScopeId,
				CodeVis );
			Iterator<ICFBamInt32ColObj> iter = dict.values().iterator();
		...
		deepDisposeInt32ColByScopeCodeVisIdx( TenantId,
				ScopeId,
				CodeVis );
	}
