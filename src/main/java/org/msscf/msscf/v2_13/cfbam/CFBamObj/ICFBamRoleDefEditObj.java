// Description: Java 11 Instance Edit Object interface for CFBam RoleDef.
...
public interface ICFBamRoleDefEditObj
	extends ICFBamRoleDefObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFBamRoleDefObj.
	 */
	ICFBamRoleDefObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFBamRoleDefObj.
	 */
	ICFBamRoleDefObj getOrigAsRoleDef();
	 ...
	 */
	ICFBamRoleDefObj create();

	/*
	 *	Update the instance.
	 */
	CFBamRoleDefEditObj update();

	/*
	 *	Delete the instance.
	 */
	CFBamRoleDefEditObj deleteInstance();
