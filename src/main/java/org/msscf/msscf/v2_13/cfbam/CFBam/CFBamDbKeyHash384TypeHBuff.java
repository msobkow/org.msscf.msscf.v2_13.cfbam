// Description: Java 11 implementation of a DbKeyHash384Type history buffer object.
...
public class CFBamDbKeyHash384TypeHBuff
	extends CFBamDbKeyHash384DefHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash384TypeHBuff() {
		super();
		requiredSchemaDefId = CFBamDbKeyHash384TypeBuff.SCHEMADEFID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash384TypeBuff.CLASS_CODE );
	}
	...
	public void setRequiredSchemaDefId( long value ) {
		if( value < CFBamDbKeyHash384TypeBuff.SCHEMADEFID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredSchemaDefId",
				1,
				"value",
				value,
				CFBamDbKeyHash384TypeBuff.SCHEMADEFID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash384TypeHBuff ) {
			CFBamDbKeyHash384TypeHBuff rhs = (CFBamDbKeyHash384TypeHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash384TypeBuff ) {
			CFBamDbKeyHash384TypeBuff rhs = (CFBamDbKeyHash384TypeBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash384TypeBySchemaIdxKey ) {
			CFBamDbKeyHash384TypeBySchemaIdxKey rhs = (CFBamDbKeyHash384TypeBySchemaIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredSchemaDefId() != rhs.getRequiredSchemaDefId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash384TypeBuff ) {
			setDbKeyHash384TypeBuff( (CFBamDbKeyHash384TypeBuff)src );
		}
		else {
	...
	public void setDbKeyHash384TypeBuff( CFBamDbKeyHash384TypeBuff src ) {
		super.setDbKeyHash384DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash384TypeHBuff ) {
			setDbKeyHash384TypeBuff( (CFBamDbKeyHash384TypeHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash384TypeHBuff" );
		}
	}

	public void setDbKeyHash384TypeBuff( CFBamDbKeyHash384TypeHBuff src ) {
		super.setDbKeyHash384DefBuff( src );
		setRequiredSchemaDefId( src.getRequiredSchemaDefId() );
	}
}
