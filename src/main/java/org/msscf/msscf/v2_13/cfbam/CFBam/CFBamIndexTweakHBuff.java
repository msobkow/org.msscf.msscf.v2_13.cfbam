// Description: Java 11 implementation of a IndexTweak history buffer object.
...
public class CFBamIndexTweakHBuff
		...
		Serializable
{
	...
	public CFBamIndexTweakHBuff() {
		super();
		requiredIndexId = CFBamIndexTweakBuff.INDEXID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamIndexTweakBuff.CLASS_CODE );
	}
