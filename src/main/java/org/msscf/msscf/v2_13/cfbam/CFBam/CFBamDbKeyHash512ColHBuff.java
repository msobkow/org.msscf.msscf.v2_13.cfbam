// Description: Java 11 implementation of a DbKeyHash512Col history buffer object.
...
public class CFBamDbKeyHash512ColHBuff
		...
		Serializable
{
	...
	public CFBamDbKeyHash512ColHBuff() {
		super();
		requiredTableId = CFBamDbKeyHash512ColBuff.TABLEID_INIT_VALUE;
	}

	public String getClassCode() {
		return( CFBamDbKeyHash512ColBuff.CLASS_CODE );
	}
	...
	public void setRequiredTableId( long value ) {
		if( value < CFBamDbKeyHash512ColBuff.TABLEID_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				"setRequiredTableId",
				1,
				"value",
				value,
				CFBamDbKeyHash512ColBuff.TABLEID_MIN_VALUE );
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof CFBamDbKeyHash512ColHBuff ) {
			CFBamDbKeyHash512ColHBuff rhs = (CFBamDbKeyHash512ColHBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
		...
		else if( obj instanceof CFBamDbKeyHash512ColBuff ) {
			CFBamDbKeyHash512ColBuff rhs = (CFBamDbKeyHash512ColBuff)obj;
			if( ! super.equals( obj ) ) {
				return( false );
			}
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
		...
		else if( obj instanceof CFBamDbKeyHash512ColByTableIdxKey ) {
			CFBamDbKeyHash512ColByTableIdxKey rhs = (CFBamDbKeyHash512ColByTableIdxKey)obj;
			if( getRequiredTenantId() != rhs.getRequiredTenantId() ) {
				return( false );
			}
			if( getRequiredTableId() != rhs.getRequiredTableId() ) {
	...
	public void set( CFBamValueBuff src ) {
		if( src instanceof CFBamDbKeyHash512ColBuff ) {
			setDbKeyHash512ColBuff( (CFBamDbKeyHash512ColBuff)src );
		}
		else {
	...
	public void setDbKeyHash512ColBuff( CFBamDbKeyHash512ColBuff src ) {
		super.setDbKeyHash512DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}

	public void set( CFBamValueHBuff src ) {
		if( src instanceof CFBamDbKeyHash512ColHBuff ) {
			setDbKeyHash512ColBuff( (CFBamDbKeyHash512ColHBuff)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
				"src",
				src,
				"CFBamDbKeyHash512ColHBuff" );
		}
	}

	public void setDbKeyHash512ColBuff( CFBamDbKeyHash512ColHBuff src ) {
		super.setDbKeyHash512DefBuff( src );
		setRequiredTableId( src.getRequiredTableId() );
	}
}
